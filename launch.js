...
//
// Usage: node launch.js   (or double-click launch.bat)
...
function startWorker(attempt = 0) {
  ...
  log('launch', `starting worker (node server.js) on :${WORKER_PORT}...`);
  ...
  // Reset backoff once it has run a healthy stretch.
